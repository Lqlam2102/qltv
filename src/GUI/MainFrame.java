...
public class MainFrame extends JFrame {
    ...
    private JLabel lbMSV;
    private JTextField tbMSV;
    ...
    private JComboBox cbGioiTinh_dg;
    private JComboBox cbGioiTinh_nv;
...
//    private JTextField txtgioitinhnv;
    ...
    public void menuleft() {
        ...
        lblthuviensgu = new JLabel("Th\u01B0 Vi\u1EC7n VNUF");
...
//        JFreeChart chart = ChartFactory.createPieChart3D("Thống Kê Sách Đã Mượn", p);
        JFreeChart chart = ChartFactory.createPieChart("Thống Kê Sách Đã Mượn", p);
...
//        panel_2.add(txtgioitinhnv);
        ...
        cbGioiTinh_nv = new JComboBox(gioitinh);
        cbGioiTinh_nv.setFont(new Font("Tahoma", Font.BOLD, 15));
        cbGioiTinh_nv.setBounds(608, 13, 199, 39);
        panel_2.add(cbGioiTinh_nv);
    ...
    private void docgia() {
        ...
        lbMSV = new JLabel("Mã Sinh Viên");
        lbMSV.setFont(new Font("Tahoma", Font.BOLD, 15));
//        lbMSV.setBounds(91, 13, 91, 36);
        lbMSV.setBounds(91, 65, 100, 36);
        panelthongtindocgia.add(lbMSV);
        
        tbMSV = new JTextField();
        tbMSV.setFont(new Font("Tahoma", Font.PLAIN, 15));
        tbMSV.setBounds(192, 65, 208, 36);
        panelthongtindocgia.add(tbMSV);
        tbMSV.setColumns(10);
        ...
        lblgioitinhdocgia.setBounds(453, 65, 91, 36);
        panelthongtindocgia.add(lblgioitinhdocgia);
        
        cbGioiTinh_dg = new JComboBox(gioitinh);
        cbGioiTinh_dg.setFont(new Font("Tahoma", Font.BOLD, 15));
        cbGioiTinh_dg.setBounds(569, 65, 208, 36);
        panelthongtindocgia.add(cbGioiTinh_dg);
...
//                    txtgioitinhnv.setText(dtmnhanvien.getValueAt(i, 3).toString());
                    cbGioiTinh_nv.setSelectedItem(dtmnhanvien.getValueAt(i, 3).toString());
        ...
        btnthemnv.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                NhanVien nv;
                nv = new NhanVien(0, txttennv.getText(), txtnamsinhnv.getText(), cbGioiTinh_nv.getSelectedItem().toString(),
                        txtsodienthoainv.getText(), txtdiachinv.getText());
